document.addEventListener('DOMContentLoaded', function() {
    ...
    const nbuLink = document.querySelector('a[href="nbu.html"]');
    ...
    function loadNBUContent() {
        const nbuContent = `
            ...
            <div class="content">
                ...
                <div id="main-content">
                    <h1>NBU Dashboard</h1>
                    <p>Welcome to the NBU dashboard. Select an option from the sidebar.</p>
                </div>
            </div>
        `;
    ...
    function printReport() {
        ...
        printWindow.document.write('<html><head><title>NBU REPORT</title>');

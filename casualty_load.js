document.addEventListener('DOMContentLoaded', function() {
    ...
    const nbuLink = document.querySelector('a[href="casualty.html"]');
    ...
    function loadNBUContent() {
        const nbuContent = `
            ...
            <div class="content">
                ...
                <div id="main-content">
                    <h1>CASUALTY Dashboard</h1>
                    <p>Welcome to the CASUALTY WARD dashboard. Select an option from the sidebar.</p>
                </div>
            </div>
        `;
    ...
    function printReport() {
        ...
        printWindow.document.write('<html><head><title>CASUALTY WARD REPORT</title>');

document.addEventListener('DOMContentLoaded', function() {
    ...
    const nbuLink = document.querySelector('a[href="paediactric.html"]');
    ...
    function loadNBUContent() {
        const nbuContent = `
            ...
            <div class="content">
                <div id="sidebar">
                    <ul>
                        <header>PAEDIACTRIC WARD</header>
                ...
                <div id="main-content">
                    <h1>PAEDIACTRIC WARD Dashboard</h1>
    ...
    function printReport() {
        ...
        printWindow.document.write('<html><head><title>PAEDIACTRIC WARD REPORT</title>');

document.addEventListener('DOMContentLoaded', function() {
    ...
    const nbuLink = document.querySelector('a[href="female_ward.html"]');
    ...
    function loadNBUContent() {
        const nbuContent = `
            ...
            <div class="content">
                ...
                <div id="main-content">
                    <h1>FEMALE Dashboard</h1>
                    <p>Welcome to the FEMALE WARD dashboard. Select an option from the sidebar.</p>
                </div>
            </div>
        `;
    ...
    function printReport() {
        ...
        printWindow.document.write('<html><head><title>FEMALE WARD REPORT</title>');

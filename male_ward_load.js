document.addEventListener('DOMContentLoaded', function() {
    ...
    const nbuLink = document.querySelector('a[href="male_ward.html"]');
    ...
    function loadNBUContent() {
        const nbuContent = `
            ...
            <div class="content">
                ...
                <div id="main-content">
                    <h1>MALE WARD Dashboard</h1>
                    <p>Welcome to the MALE WARD dashboard. Select an option from the sidebar.</p>
                </div>
            </div>
        `;
    ...
    function printReport() {
        ...
        printWindow.document.write('<html><head><title>MALE WARD REPORT</title>');

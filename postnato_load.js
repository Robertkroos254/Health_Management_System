document.addEventListener('DOMContentLoaded', function() {
    ...
    const nbuLink = document.querySelector('a[href="postnato.html"]');
    ...
    function loadNBUContent() {
        const nbuContent = `
            ...
            <div class="content">
                ...
                <div id="main-content">
                    <h1>POST-NATAL Dashboard</h1>
                    <p>Welcome to the POST-NATAL dashboard. Select an option from the sidebar.</p>
                </div>
            </div>
        `;
    ...
    function printReport() {
        ...
        printWindow.document.write('<html><head><title>POST-NATAL REPORT</title>');
